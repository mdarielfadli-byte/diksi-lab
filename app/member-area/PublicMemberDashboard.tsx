...
export function PublicMemberDashboard() {
  ...
  return <main className={styles.dashboard}>
    <aside className={styles.sidebar}>
      ...
      <nav className={styles.nav} aria-label="Navigasi dashboard"><a className={styles.active} href="#overview">◈ <span>Dashboard</span></a><a href="#calendar">▥ <span>Kalender</span></a><a href="#roadmap">↗ <span>Roadmap</span></a><a href="#planned">◷ <span>Akan dilakukan</span></a><a href="#completed">✓ <span>Telah dilakukan</span></a><a href="#updates">◌ <span>Update &amp; approval</span></a><a href="#documents">▤ <span>Dokumen</span></a></nav>
